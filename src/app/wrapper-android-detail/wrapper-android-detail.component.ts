...
@Component({
  selector: 'app-wrapper-android-detail',
  templateUrl: './wrapper-android-detail.component.html',
  styleUrls: ['./wrapper-android-detail.component.css']
})
export class WrapperAndroidDetailComponent implements OnInit {
  systemObject: string = '';
